...
| [R-0013](0013-matmul-moonshot.md) | The matmul-decomposition **moonshot** — the relocated Strassen prize; a stronger (non-blind) proposer over the R-0006/7/8 seam | M5 — Discovery (**moonshot**) | Draft (Gate 0 = rediscover Strassen where blind GA got 0/10; first probe inconclusive — needs a fast-search harness) |
